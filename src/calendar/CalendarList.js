...
class CalendarList extends Component {
    ...
    componentDidMount() {
        const { minDate, maxDate, firstDayOnWeeks, startDateInit, endDateInit } = this.props;
        console.log('startDateInit', startDateInit)
        this.setState({
...
CalendarList.propTypes = {
    ...
    startDateInit: PropTypes.string,
    endDateInit: PropTypes.string,
};
...
CalendarList.defaultProps = {
    ...
    selectedDateMarkRangeColor: '#0066B31A',
